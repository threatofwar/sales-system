...
func main() {
	...
	authGroup.GET("/product", handlers.GetProductsHandler)
	authGroup.GET("/product/:id", handlers.GetProductByIDHandler)
	authGroup.POST("/product", handlers.CreateProductHandler)
